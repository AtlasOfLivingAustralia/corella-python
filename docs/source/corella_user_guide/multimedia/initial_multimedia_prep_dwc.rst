...
To add your multimedia extension to your archive, you will need to create a new file titled ``multimedia.txt``.  
The only two fields required to tie your multimedia to your occurrences:

- ID of the sighting that the multimedia is associated with
